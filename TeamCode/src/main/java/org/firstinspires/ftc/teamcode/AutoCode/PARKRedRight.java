...
@Autonomous(name="PARKRedRight Auto", group="CompetitionAuto")
//@Disabled
public class PARKRedRight extends AutoSupplies {
    @Override
    public void runOpMode() {
        ...
        if (daWay == 1) {
            ...
            encoderMove(775, -0.5, 0);
            pause(1500);
            encoderMove(775, 0, 1);
        } else if (daWay == 2) {
            lights.setPattern(RevBlinkinLedDriver.BlinkinPattern.GREEN);
            encoderMove(125, -0.3, 0.3);
            pause(1500);
            encoderMove(700, 0, 1);
        } else if(daWay == 3){
            lights.setPattern(RevBlinkinLedDriver.BlinkinPattern.BLUE);
            encoderMove(750, 0.5, 0);
            pause(1500);
            encoderMove(775, 0, 1);
        } else{
