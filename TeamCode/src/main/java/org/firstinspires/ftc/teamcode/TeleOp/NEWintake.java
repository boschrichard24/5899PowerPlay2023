...
@TeleOp(name="NEWintake", group="TeleOp")
//@Disabled
public class NEWintake extends LinearOpMode{
    ...
    protected DcMotor motorIntake   = null;
...
// ### SPEED CHANGE STUFFINGS ### \\
            ...
            telemetry.addData("INTAKE Position", motorIntake.getCurrentPosition()); //to be used when the encoders are ready
