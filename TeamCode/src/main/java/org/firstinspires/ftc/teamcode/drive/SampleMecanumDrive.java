...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(/*0.15*/8, 0, 0);
    ...
    public DcMotorEx motorFwdLeft;
    public DcMotorEx motorBackLeft;
    public DcMotorEx motorFwdRight;
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap, boolean... odametry) {
        ...
        boolean odametryOption = (odametry.length >= 1) ? odametry[0] : true;
        ...
        motors = Arrays.asList(motorFwdLeft, motorBackLeft, motorFwdRight, motorBackRight);
        ...
        if (!odametryOption && MOTOR_VELO_PID != null) {
            setPIDFCoefficients(DcMotor.RunMode.RUN_USING_ENCODER, MOTOR_VELO_PID);
        }

        // TODO: reverse any motors using DcMotor.setDirection()

        motorBackLeft.setDirection(DcMotor.Direction.REVERSE); // original just this
    ...
    public void turnAsync(double angle, double maxVel, double maxAccel) {
        double heading = getPoseEstimate().getHeading();
    ...
    public void turn(double angle, double maxVel, double maxAccel) {
        turnAsync(angle, maxVel, maxAccel);
        waitForIdle();
    }
    ...
    public static void switchState(ThreadState thread) {
        threadState = thread;
    }

    public static ThreadState getState() {
        return threadState;
    }

    public static class ExternalDriveThread extends Thread {
        SampleMecanumDrive drive;

        public ExternalDriveThread(HardwareMap hw, SampleMecanumDrive d) {
    ...
    public void setMotorPowers(double v, double v1, double v2, double v3) {
        motorFwdLeft.setPower(v);
        motorBackLeft.setPower(v1);
        motorFwdRight.setPower(v2);
